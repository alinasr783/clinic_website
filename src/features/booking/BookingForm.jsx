...
function BookingForm({booking = null, onBookingUpdated, onClose}) {
  ...
  return (
    <div className="bg-dark-2 p-4 sm:p-6 lg:p-8 rounded-2xl max-w-7xl mx-auto">
      <form
                  ...
                  render={({field}) => (
                    <input
                      ...
                      className={`w-full bg-gray-800 border rounded-lg px-4 py-3 text-white focus:outline-none 
                          focus:ring-2 focus:border-transparent text-base sm:text-sm transition-colors
                          ${
                            errors.userName
                              ? "border-red-500 focus:ring-red-500"
                              : "border-gray-600 focus:ring-white-500"
                          }`}
                    />
                  )}
                />
              ...
              <Controller
                ...
                render={({field}) => (
                  <select
                    {...field}
                    className={`w-full bg-gray-800 border rounded-lg px-4 py-3 text-white focus:outline-none 
                        focus:ring-2 focus:border-transparent appearance-none cursor-pointer text-base sm:text-sm transition-colors
                        ${
            ...
            <div className="bg-gray-800 rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                ...
                <span className="text-white font-medium text-sm sm:text-base break-words">
                  {watchedValues.selectedCountry || "No country selected"}
                </span>
              </div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                <span className="text-gray-400 text-sm">Service:</span>
                <span className="text-white font-medium text-sm sm:text-base break-words">
                  {watchedValues.selectedService || "No service selected"}
                </span>
              </div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
              ...
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                ...
                <span className="text-white font-medium text-sm sm:text-base">
                  {watchedValues.selectedTime}
                </span>
              </div>
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
                <span className="text-gray-400 text-sm">Dentist:</span>
                <span className="text-white font-medium text-sm sm:text-base">
                  Dr. Evelyn Reed
                </span>
              </div>
